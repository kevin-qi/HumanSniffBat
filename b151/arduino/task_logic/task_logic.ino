...
#define RESET_STATE_VAL 0
#define READY_STATE_VAL 1
#define STIM_STATE_VAL 43
#define OPEN_STATE_VAL 85
#define REW_STATE_VAL 127
...
void on_ready_enter() {
  analogWrite(PWM_STATE_PIN, READY_STATE_VAL);
...
void on_stim_enter() {
  analogWrite(PWM_STATE_PIN, STIM_STATE_VAL);
...
void on_open_enter() {
  analogWrite(PWM_STATE_PIN, OPEN_STATE_VAL);
...
void on_rew_enter() {
  analogWrite(PWM_STATE_PIN, REW_STATE_VAL);
...
void on_reset_enter() {
  Serial.print("RESET_ENTER:"+String(millis())+"(ERR:"+err+")|");
  analogWrite(PWM_STATE_PIN, RESET_STATE_VAL);
  target_feeder = "";
}

void on_reset_exit() {
  Serial.print("RESET_EXIT:"+String(millis())+"|");
}
